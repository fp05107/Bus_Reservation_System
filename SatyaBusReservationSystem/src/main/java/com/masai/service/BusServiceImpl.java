...
public class BusServiceImpl implements BusService {
    ...
    public Bus addBus(Bus bus, String key) throws BusException, LoginException {
        ...
        CurrentAdminSession validAdminSession = sr.findByAdminUID(key);
...
//			
////        Route route =rRepo.findByRouteFromAndRouteTo(bus.getRouteFrom(),bus.getRouteTo());
//		Route route = 	rRepo1.findByRouteFromAndRouteTo(bus.getRouteTo(), bus.getRouteFrom());
//        
//        		if(route != null) {
////        			route.getBus().add(bus);
//        			route.getBusList().add(bus);
//        			bus.setRoute(route);
//        			return bRepo1.save(bus);
//        		}
//	else {
//			throw new BusException("Bus not added due to technical error");
//		}
...
//		}
//         
//		Optional<Bus> updateBusOpt =bRepo1.findById(bus.getBusId());
//		Bus Bus2 = new Bus();
//	      
//		if(updateBusOpt.isPresent()) {
//			Bus existingBus = updateBusOpt.get();
...
//		
//			Route route=rRepo1.findByRouteFromAndRouteTo(bus.getRouteFrom(), bus.getRouteTo());
//			if(route == null) throw new BusException("Invalid route!");
//			bus.setRoute(route);
//			return bRepo1.save(bus);
//		}
...
//		
//		Bus Bus2 = new Bus();
//		 Optional < Bus > optional = bRepo1.findById(busId);
//	        if (optional.isPresent()) {
//	        	Bus2.setBusName(optional.get().getBusName());
//	        	Bus2.setBusType(optional.get().getBusType());
//	        	Bus2.setDriverName(optional.get().getDriverName());
...
//	public List<Bus> viewBusByType(String BusType) throws BusException {
//		// TODO Auto-generated method stub
//		 List<Bus> listOfBusType = bRepo1.findByBusType(BusType);
//			
//			if(listOfBusType.size() >0)
//				return listOfBusType;
//			else
...
//	public List<Bus> viewAllBuses() throws BusException {
//		// TODO Auto-generated method stub
//		List<Bus> listOfBusType = bRepo1.findAll();
//		
//		if(listOfBusType.size() >0)
//			return listOfBusType;
//		else
